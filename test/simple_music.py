...
ukulele = VideoFileClip("datasets/friends_10_04.mp4", audio=True). \
    subclip(60 + 33, 60 + 50). \
...
piano = (VideoFileClip("datasets/friends_10_04.mp4", audio=False).
         subclip(30, 50).
...
# final.subclip(0, 5).write_videofile("datasets/ukulele.avi", fps=24, codec='libx264')
